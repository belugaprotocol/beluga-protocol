...
contract ModuleProxy is BaseUpgradeabilityProxy {
  ...
  * the governance can upgrade the module
  */
  function upgrade() external {
    (bool should, address newImplementation) = IUpgradeSource(address(this)).shouldUpgrade();
    require(should, "Module Proxy: Upgrade not scheduled");
    ...
    require(success, "Module Proxy: Issue when finalizing the upgrade");
  }
